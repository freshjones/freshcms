<template>
  <div>
    <button type="button" class="btn btn-outline-primary mb-3" @click="handleModalToggle">Add Billboard</button>
...
<script>
    ...
    export default {
        ...
        mounted() {
          axios.get('/billboard/' + this.$props.page + '/' + this.$props.section)
            .then(response => {
